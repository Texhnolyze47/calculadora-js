...
export default class CalculatorController{
    ...
    constructor(){
    this.calculatorModel = new CalculatorModel("0", null, WAITING_FOR_FIRST_OPERATOR, null);
    ...
    inputDecimal(dot){
      if (this.calculatorModel.waitingForSecondOperator === WAITING_FOR_SECOND_OPERATOR) {
        ...
        this.calculatorModel.waitingForSecondOperator = WAITING_FOR_FIRST_OPERATOR;
        return;
      }
